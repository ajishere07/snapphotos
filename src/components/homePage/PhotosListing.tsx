...
const PhotosListing: FC<Props> = ({ images }) => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="border-black border-1 grid  gap-2 grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
        {images.map((data: any, index: number) => (
          <div key={index} className="relative md:h-52 md:w-48 h-32  w-36">
            <img
